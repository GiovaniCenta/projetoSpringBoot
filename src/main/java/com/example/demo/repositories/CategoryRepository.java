...
public interface CategoryRepository extends JpaRepository<Category,Integer>{  //vai extender o repositorio do Banco de dados passando o tipo da classe e o tipo do primary key
