...
public interface OrderItemRepository extends JpaRepository<OrderItem,Integer>{  //vai extender o repositorio do Banco de dados passando o tipo da classe e o tipo do primary key
