...
public interface OrderRepository extends JpaRepository<Order,Integer>{  //vai extender o repositorio do Banco de dados passando o tipo da classe e o tipo do primary key
